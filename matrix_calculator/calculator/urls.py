...
urlpatterns = [
    ...
    path('<int:pk>/schedule/upload/', views.ScheduleUploadView.as_view(), name='schedule_upload'),
    path('<int:pk>/schedule/template.csv', views.ScheduleTemplateView.as_view(), name='schedule_template'),
